...
/// Optimized version of convert_json_to_record_batch
/// Key optimizations:
/// 1. Single-pass traversal (vs 3 passes in original)
/// 2. Zero-copy string handling
/// 3. Inline type conversions
/// 4. Bitmap for missing fields (vs HashSet)
/// 5. Pre-computed field indices
